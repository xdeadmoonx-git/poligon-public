...
1. Распакуйте архив по пути:  
   Android/Media/su.sovietgames.everlasting_summer/mods (Чтобы этот путь появился, БЛ должно быть запущено хотя бы один раз)
  
2. Для просмотра описания персонажа в архиве зажмите его имя.
  
3. То же самое касается выбора действий в игре.  
